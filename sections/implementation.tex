...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \begin{tikzpicture}[
      ...
      \path[draw,->]
      (prev1) edge (appup_generator)
      (curr1) edge (appup_generator);
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \begin{tikzpicture}[
      ...
      \path[draw,->] (curr1_app1.189) -| (appup_generator.south east);
      \path[draw,->] (curr1_app2.189) -| (appup_generator.south east);
